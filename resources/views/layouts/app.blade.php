...
<body class="flex min-h-screen">
    ...
    <aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col shadow-xl">
        ...
        <nav class="flex-grow p-4 space-y-1">
            @if(auth()->user()->isSuperAdmin())
                ...
                <a href="/admin" class="flex items-center space-x-3 py-2.5 px-4 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition">
                    <i class="fa-solid fa-chart-line"></i> <span>All locations</span>
                </a>
                ...
                <a href="/admin/subscriptions" class="flex items-center space-x-3 py-2.5 px-4 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition">
                    <i class="fa-solid fa-user-plus"></i> <span>Subscriptions</span>
                </a>
            @else
    ...
    <div class="flex-grow flex flex-col">
            ...
            <div class="flex items-center space-x-4">
                <div class="text-right">
                    ...
                    <div class="flex items-center justify-end space-x-2">
                        ...
                        <form action="{{ route('logout') }}" method="POST">@csrf<button type="submit" class="text-[10px] text-rose-400 hover:text-rose-300 font-semibold hover:underline">Logout</button></form>
                    </div>
                </div>
        ...
        <main class="p-8 flex-grow">
            ...
            @endif
            @if($errors->any())
                <div class="mb-6 bg-rose-500/10 border border-rose-500/20 text-rose-300 p-4 rounded-xl text-sm">
