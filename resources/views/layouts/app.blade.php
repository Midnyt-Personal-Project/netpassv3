...
@php
    ...
    $nav = $super ? [
        ['superadmin.dashboard','/superadmin','fa-gauge','Super dashboard'], ['admin.dashboard','/admin','fa-chart-line','All locations'], ['admin.packages','/admin/packages','fa-cubes','Packages'], ['admin.devices','/admin/devices','fa-tv','TV & devices'], ['admin.subscriptions','/admin/subscriptions','fa-user-plus','Subscriptions'],
    ] : [
        ['admin.dashboard','/admin','fa-gauge','Dashboard'], ['admin.packages','/admin/packages','fa-cubes','Packages'], ['admin.devices','/admin/devices','fa-tv','TV & devices'], ['admin.subscriptions','/admin/subscriptions','fa-user-plus','Subscriptions'],
    ];
@endphp
