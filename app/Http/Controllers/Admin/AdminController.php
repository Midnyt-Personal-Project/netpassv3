...
class AdminController extends Controller
{
    ...
    )
    {
        ...
        // Voucher SMS is sent immediately by hitting the Arkesel URL directly —
        // the exact same request you tested in the browser. No queue, no delay.
        $smsSent = $this->sendVoucherSmsDirect($customer, $package->name);
